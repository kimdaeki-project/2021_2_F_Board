...
<body>
	...
	<div class="container py-4">
    	...
    	<!-- 본문 -->
    <form action="../member/join.do" method="post" id="submitJoin">
    	<div class="container">
    		<div class="center">
    			<!-- 필수 입력 사항 -->
    			<!----------------- 아이디 ------------------->
				...
				<div class="mb-3">
					...
					<input class="form-control js-input" type="text" name="mem_username" id="username" required="required" placeholder="한글만 입력" style="width: 180px;" maxlength="10">	
				...
				<div class="mb-3">
					...
					<input class="form-control js-input inline" type="text" name="mem_nickname" id="nickname" required="required" placeholder="한글 모음, 특문 x" style="width: 180px;">	
				...
				<div class="mb-3">						
					...
					<input class="form-control js-input" type="text" name="mem_email_1" id="email" required="required" placeholder="이메일 계정 입력" maxlength="30" style="width: 200px; display: inline; margin-bottom: 3px;">
